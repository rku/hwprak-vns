...
void print_machine_state(vnsem_machine *machine)
{
    ...
    printf("[ ACCU=0x%.2x  PC=0x%.2x  SP=0x%.2x  L=0x%.2x ]  ",
            machine->accu,
            machine->pc,
            machine->sp,
            machine->reg_l);
